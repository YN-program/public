---
title: "アルツハイマー病他、神経変性疾患は薬害"
description: ""
date: "2023-08-01T14:38:55+09:00"
thumbnail: ""
categories:
  - "medical"
tags:
...
> 
> ![ミスフォールディング病１](/img/vaccine/ミスフォールディング1.png)
>
>
...
で、代表的な蛋白質ミスフォールディング病には以下のようなものがあります（上記記事より引用）。
 ...
 ![ミスフォールディング病](/img/vaccine/ミスフォールディング.png)
...
以下の記事には、重金属およびメタロイド（[半金属](https://ja.wikipedia.org/wiki/%E5%8D%8A%E9%87%91%E5%B1%9E)）が、蛋白質のフォールディングを妨げ、蛋白質の凝集を誘導すると記載されています。
...
> 
> [Heavy metals and metalloids as a cause for protein misfolding and aggregation](https://www.mdpi.com/2218-273X/4/1/252)
> 
...
>
> [薬の種類や多剤併用が及ぼすヒト腸内細菌への全貌を解明～世界に類を見ない腸内細菌叢ビッグデータベースを構築～](https://www.ncgm.go.jp/pressrelease/2022/20220720.html)
>
...
](https://rapt-neo.com/?p=16064)

##### おすすめ

{{<x user="Rapt_plusalpha" id="1685592751625449472">}}
&nbsp;

{{<x user="Rapt_plusalpha" id="1685982257146925056">}}
&nbsp;

{{<x user="Rapt_plusalpha" id="1685974490747138048">}}
&nbsp;

{{<x user="Rapt_plusalpha" id="1685971622430384128">}}
&nbsp;

{{<x user="Rapt_plusalpha" id="1685962990015877120">}}
&nbsp;

{{<x user="Rapt_plusalpha" id="1685959671935602689">}}
&nbsp;

{{<x user="Rapt_plusalpha" id="1685957927088394240">}}
&nbsp;
